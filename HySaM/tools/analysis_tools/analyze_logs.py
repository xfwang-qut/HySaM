...
def plot_curve(log_dicts, args):
    ...
    sns.set_style("white")  # 设为白色背景
    plt.figure(facecolor='white')  # 确保图形背景也是白色
    plt.figure(figsize=(7, 5), dpi=600)
    plt.rcParams["font.family"] = "Times New Roman"  # 统一全局字体为 Times New Roman
    plt.rcParams.update({'font.size': 14})  # 统一全局字体大小
