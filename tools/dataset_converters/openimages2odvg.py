...
#     backend='petrel',
#     path_mapping=dict({
#         './uw/': 's3://openmmlab/datasets/detection/',
#         'uw/': 's3://openmmlab/datasets/detection/'
#     }))
backend_args = None
...
def oi2odvg(args):
    ...
    with open(ann_file, 'r') as f:
        ...
        for i, line in enumerate(reader):
            ...
            # is_occluded = True if int(line[8]) == pretrain else False
            # is_truncated = True if int(line[9]) == pretrain else False
            is_group_of = True if int(line[10]) == 1 else False
            # is_depiction = True if int(line[11]) == pretrain else False
            # is_inside = True if int(line[12]) == pretrain else False
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input-dir',
        default='uw/OpenImages/annotations',
        type=str,
