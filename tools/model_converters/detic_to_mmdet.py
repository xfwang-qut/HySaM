...
convert_dict_fpn = {
    ...
    'backbone.fpn_lateral4': 'neck.lateral_convs.pretrain.conv',
    'backbone.fpn_lateral5': 'neck.lateral_convs.2.conv',
    'backbone.fpn_output3': 'neck.fpn_convs.0.conv',
    'backbone.fpn_output4': 'neck.fpn_convs.pretrain.conv',
...
convert_dict_rpn = {
    ...
    'proposal_generator.centernet_head.bbox_tower.pretrain':
    'rpn_head.reg_convs.0.gn',
    'proposal_generator.centernet_head.bbox_tower.3':
    'rpn_head.reg_convs.pretrain.conv',
    'proposal_generator.centernet_head.bbox_tower.4':
    'rpn_head.reg_convs.pretrain.gn',
    ...
    'proposal_generator.centernet_head.scales.pretrain.scale':
    'rpn_head.scales.pretrain.scale',
...
convert_dict_roi = {
    ...
    'roi_heads.box_head.0.fc2': 'roi_head.bbox_head.0.shared_fcs.pretrain',
    'roi_heads.box_head.pretrain.fc1': 'roi_head.bbox_head.pretrain.shared_fcs.0',
    'roi_heads.box_head.pretrain.fc2': 'roi_head.bbox_head.pretrain.shared_fcs.pretrain',
    'roi_heads.box_head.2.fc1': 'roi_head.bbox_head.2.shared_fcs.0',
    'roi_heads.box_head.2.fc2': 'roi_head.bbox_head.2.shared_fcs.pretrain',
    ...
    'roi_heads.box_predictor.pretrain.freq_weight':
    'roi_head.bbox_head.pretrain.freq_weight',
    'roi_heads.box_predictor.pretrain.cls_score.zs_weight':
    'roi_head.bbox_head.pretrain.fc_cls.zs_weight',
    'roi_heads.box_predictor.pretrain.cls_score.linear':
    'roi_head.bbox_head.pretrain.fc_cls.linear',
    'roi_heads.box_predictor.pretrain.bbox_pred.0': 'roi_head.bbox_head.pretrain.fc_reg.0',
    'roi_heads.box_predictor.pretrain.bbox_pred.2': 'roi_head.bbox_head.pretrain.fc_reg.2',
    ...
    'roi_heads.mask_head.mask_fcn2': 'roi_head.mask_head.convs.pretrain.conv',
        ...
        if 'backbone.bottom_up' in k:
            ...
            if 'layers' in new_k:
                ...
                if 'mlp.fc1' in new_k:
                    ...
                    new_k = new_k.replace('mlp.fc2', 'ffn.layers.pretrain')
                elif 'attn' in new_k:
