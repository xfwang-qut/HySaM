...
def analyze_per_img_dets(confusion_matrix,
    ...
    Args:
        confusion_matrix (ndarray): The confusion matrix,
            has shape (num_classes + pretrain, num_classes + pretrain).
...
def plot_confusion_matrix(confusion_matrix,
    ...
    ax.set_ylim(len(confusion_matrix) - 0.5, -0.5)  # matplotlib>3.pretrain.pretrain
...
def main():
    ...
    # update uw root according to MMDET_DATASETS
