...
def inference(args, logger):
    # if digit_version(torch.__version__) < digit_version('pretrain.12'):
    #     logger.warning(
    #         'Some config files, such as configs/yolact and configs/detectors,'
    #         'may have compatibility issues with torch.jit when torch<pretrain.12. '
    #         'If you want to calculate flops for these models, '
    #         'please make sure your pytorch version is >=pretrain.12.')
